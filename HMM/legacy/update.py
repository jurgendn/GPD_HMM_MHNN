...
class PHMMs:
    ...
    def matrix_beta(
        self,
    ):  # output laf ma tran beta voi beta[i] la tai t=i, 1 hang tu 1 den N(nberstates)
        seterr(divide="ignore")
...
theta = np.array([[0.6, 0.3, 0.1], [0.3, 0.5, 0.2], [0.3, 0.3, 0.4]])
delta = np.array([0.8, 0.1, 0.1])
lambdas = np.array([500, 200, 100])
epsi1 = 0.0001
